  ...
  return (
    <>
      ...
      >
        ...
        {/* Imagem superior esquerda (oculta em mobile) */}
        {!isMobile && (
          <Box position="absolute" top="20px" left={{ base: '20px', md: '80px' }}>
            <Image src="/images/duvida.png" w={{ base: '100px', md: '200px' }} h={{ base: '100px', md: '200px' }} borderRadius="50%" />
          </Box>
        )}

        {/* Imagem inferior direita (oculta em mobile) */}
        {!isMobile && (
          <Box position="absolute" bottom="20px" right={{ base: '10px', md: '20px' }}>
            <Image src="/images/pulaPula.png" w={{ base: '110px', md: '220px' }} h={{ base: '104px', md: '208px' }} borderRadius="50%" />
          </Box>
        )}
          ...
          {role === 'ROLE_FUNCIONARIO_ADMIN' && (
            <Box w="100%" display="flex" justifyContent="center">
              <FormControl maxW={{ base: "100%", md: "80%" }} w="100%">
                <FormLabel textAlign="center">Cadastrar Mensagem</FormLabel>
                <Box display="flex" justifyContent="center"> {/* Centraliza o Textarea e o Button */}
                  <Textarea
                    value={conteudo}
                    onChange={e => {
                      setConteudo(e.target.value);
                ...
                <Box display="flex" justifyContent="center" mt={4}> {/* Centraliza o Button */}
                  <Button
                    onClick={salvar}
                    colorScheme="green"
                    fontFamily="Delius"
